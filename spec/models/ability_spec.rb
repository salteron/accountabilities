...
describe Ability do
  ...
  describe 'bank related abilities' do
    ...
    let(:accessible_banks) { Bank.accessible_by(user_with_ability) }
  ...
  describe 'client related abilities' do
    let(:client) { create(:client) }
    let(:accessible_clients) { Client.accessible_by(user_with_ability) }
  ...
  describe 'agent related abilities' do
    let(:agent) { create(:agent) }
    let(:accessible_agents) { Agent.accessible_by(user_with_ability) }
